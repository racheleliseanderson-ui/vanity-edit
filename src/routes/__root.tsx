    ...
    <div className="flex min-h-dvh items-center justify-center bg-background px-5">
      <div className="max-w-xl text-center">
        ...
        <h1 className="display mt-6 text-5xl md:text-7xl">
          This page is <span className="gilt-text italic">not in the edit.</span>
        </h1>
        <nav
        ...
        >
          ...
          <Link to="/products" className="transition-colors hover:text-champagne">
            Products
          </Link>
          <Link to="/desk" className="transition-colors hover:text-champagne">
            Desk
          </Link>
          <Link to="/insights" className="transition-colors hover:text-champagne">
            Insights
          </Link>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;1,300;1,400&family=IBM+Plex+Mono:wght@400;500&family=Jost:wght@300;400;500&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
